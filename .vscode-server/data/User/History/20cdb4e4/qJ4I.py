...
api_key = "45d4fbcc1a4f646db39b732cacb91bc7"
...
with DAG('weather_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_transform_weather_data")}} s3://airflowslack-bkt',
        )
        ...
        extract_transform_weather_data >> load_to_s3 
        #>> slack_notification
